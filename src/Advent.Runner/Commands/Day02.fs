...
type Day02() =
  ...
  member this.loadTournament =
    let tournament = Tournament.parse this.readInputAsSeq
    tournament

  override this.part1() =
    let tournament = this.loadTournament
    printfn $"The total result from the Rock, Paper, Scissors tournament is %i{tournament.TotalPoints}"

  override this.part2() =
    let tournament2 = Tournament.parseUpdated this.readInputAsSeq
